...
//
//                // Open Repo Item
//                let html_url = "http://www.google.com";
...
//
////                this._notificationbin.add(gitHubRepoMenuItem.actor);
////                gitHubRepoMenuItem.actor._parent_container = this._notificationbin;
//
//                // Project Home Item
...
//
//                // Details : Watchers
//                let openWatchers = this._createPopupImageMenuItem(_(L2Indent + "Watchers: " + 10), "avatar-default-symbolic", function () {
//                    this._openUrl("https://github.com//watchers");
//                }, { reactive: true });
//                gitHubRepoDetailsItem.menu.addMenuItem(openWatchers);
//
//                this._notificationbin.add(gitHubRepoDetailsItem.actor);
//                gitHubRepoDetailsItem.actor._parent_container = this._notificationbin;
//            }
